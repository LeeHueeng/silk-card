...
株アプリのようになぞれるグラフから、カード全体をドラッグして調光するライト、部屋を一行に要約するルームカードまで — 191 種類のカードがひとつのデザイン言語を共有します。設定ゼロでも美しい。
...
| 高度なチャート | Sankey · Treemap · Radar · 年間ヒートマップ · Gantt · 散布図 · ヒストグラム · ローソク · ウォーターフォール · 箱ひげ · 積み上げ · ドーナツ · Sparkbar · トレンド · Delta · 小さな複数 |
| エネルギー深掘り | 機器別内訳 · 炭素強度 · 料金予測 · ピーク · 太陽光予報 · 自家消費率 · 待機電力 · 月間目標 |
| サーバー・ネットワーク | Ping · Docker · サーバー統計 · 帯域 · WAN · VPN · 証明書 · バックアップ |
| 暮らし | 買い物 · 献立 · 家事 · 服薬 · ペット · ゴミ · 誕生日 · フィットネス · 睡眠 · 水分 |
| 移動・外出 | 発車標 · 通勤 · フライト · 荷物 · 燃料 · 駐車 |
| セキュリティ深掘り | カメラウォール · ドアベル · モーション履歴 · 訪問記録 · ゾーン · パニック |
| HA システム | インスタンス · 統合の健康度 · 消えた実体 · 自動化監査 · DB · アドオン · エラーログ · 再起動 |
| アンビエント | 名言 · 今日 · 水槽 · 暖炉 · ムード照明 · おやすみ · 目覚め · ポモドーロ |
| ニッチ領域 | 給湯器 · バルブ · サイレン · テキスト · 日付時刻 · バイナリ詳細 |

ギャラリー全体（320+ バリエーション）: [gallery.png](gallery.png) · ローカルで試す: `npm run demo`
